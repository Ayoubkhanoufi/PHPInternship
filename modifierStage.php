                ...
                <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/bnr1.jpg);">
                    <div class="container">
                        <div class="dez-bnr-inr-entry">
                            <h1 class="text-white">Gestion Stage</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            <li><a href="adminStagiaire.php">Gestion Stage</a></li>
                            <li>Modifier stage</li>
                        </ul>
                    </div>
                </div>
                <!-- Breadcrumb row END -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-a30 bg-gray clearfix m-b30 ">
                                    ...
                                    <form method="post" action="controller/modifierstage.php" onSubmit="return verify(this.password, this.confirmMdp)">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="datedebut" type="date" required class="form-control" value="<?php echo $stage->getDateDebut(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="datefin" type="date" required class="form-control" value="<?php echo $stage->getDateFin(); ?>">
                                                    </div>
                                                </div>
                                            </div>                                            
