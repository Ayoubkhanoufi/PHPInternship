...
<html lang="en">
    ...
    <head>
        ...
        <!-- Page Title Here -->
        <title>ORMVAD - Ajouter Encadrant</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-a30 bg-gray clearfix m-b30 ">
                                    ...
                                    <h2 class="text-center">Encadrant</h2>
                                    <div class="dzFormMsg"></div>
                                    
                                    <form method="post" action="controller/addEncadrant.php" onSubmit="return verify(this.password, this.confirmMdp)">
