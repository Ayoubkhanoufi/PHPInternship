...
<html lang="en">
    ...
    <body id="bg">
                              ...
                              <tbody>
                                  ...
                                  <tr class="odd gradeX">
                                        ...
                                        <td style="text-align:center; vertical-align:middle;" >
                                            ...
                                            <a href="ModifierEncadrant.php?&id=<?php echo $e->getId(); ?>" class="btn btn-success btn-default" style="border-radius: 7px;"><em class="fa fa-pencil "></em></a></div> 
                                        </td>
        ...
        <script lang="javascript">
            ...
            {
                if(confirm("Voulez vous supprimer l'encadrant ?")){
                    window.location.href='controller/deleteencadrant.php?id='+delid+'';
                }   
            }
        </script>
