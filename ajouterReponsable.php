...
<html lang="en">
    ...
    <head>
        ...
        <!-- Page Title Here -->
        <title>ORMVAD - Ajouter Responsable</title>
                ...
                <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/bnr1.jpg);">
                    <div class="container">
                        <div class="dez-bnr-inr-entry">
                            <h1 class="text-white">Gestion Responsable</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            <li><a href="adminStagiaire.php">Gestion Responsable</a></li>
                            <li>Ajouter Responsable</li>
                        </ul>
                    </div>
                </div>
                <!-- Breadcrumb row END -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-a30 bg-gray clearfix m-b30 ">
                                    ...
                                    <h2 class="text-center">Responsable RH</h2>
                                    <div class="dzFormMsg"></div>
                                    
                                    <form method="post" action="controller/addResponsable.php" onSubmit="return verify(this.password, this.confirmMdp)">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="nom" type="text" required class="form-control" placeholder="Nom">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="prenom" type="text" required class="form-control" placeholder="Prénom">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="adresse" type="text" required class="form-control" placeholder="Adresse">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group"> 
                                                        <input name="mdp" type="text" class="form-control" required  placeholder="Mot de passe">
                                                    </div>
                                                </div>
                                            </div>
