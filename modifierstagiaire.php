...
<html lang="en">
    ...
    <head>
        ...
        <!-- Page Title Here -->
        <title>ORMVAD - Modifier Stagiaire</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-a30 bg-gray clearfix m-b30 ">
                                    ...
                                    <form method="post" action="controller/modifierstagiaire.php" onSubmit="return verify(this.password, this.confirmMdp)">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="nom" type="text" required class="form-control" value="<?php echo $sta->getNom(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="prenom" type="text" required class="form-control" value="<?php echo $sta->getPrenom(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="datedenaissance" type="date" required class="form-control" value="<?php echo $sta->getDateNaissance(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="adresse" type="text" required class="form-control" value="<?php echo $sta->getAdresse(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="telephone" type="text" required class="form-control" value="<?php echo $sta->getTelephone(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group"> 
                                                        <input name="email" type="text" class="form-control" required  value="<?php echo $sta->getEmail(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="mdp" type="text" required class="form-control" value="<?php echo $sta->getmdp(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="confirmMdp" type="text" required class="form-control" placeholder="Confirmer vôtre mot de passe..">
                                                    </div>
                                                </div>
                                            </div>
					    <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="specialite" type="text" required class="form-control" value="<?php echo $sta->getSpecialite(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="etablissement" type="text" required class="form-control" value="<?php echo $sta->getEtablissement(); ?>">
                                                    </div>
                                                </div>
                                            </div>
