...
<html lang="en">
    ...
    <body id="bg">
                ...
                <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/bnr1.jpg);">
                    <div class="container">
                        <div class="dez-bnr-inr-entry">
                            <h1 class="text-white">Liste Encadrant</h1>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-hover">
                              ...
                              <tbody>
                                  ...
                                  <tr class="odd gradeX">
                                        ...
                                        <td><center><?php echo $e->getNom().' '.$e->getPrenom(); ?></center></td>
                                        ...
                                        <td><center><?php echo $e->getLogin(); ?></center></td>
                                        <td><center><?php echo $e->getMdp(); ?></center></td>
                            
                                        <td style="text-align:center; vertical-align:middle;" >
                                            <a onclick="deleteme(<?php echo $e->getId(); ?>)" class="btn btn-success btn-danger" style="border-radius: 7px;"><em class="fa fa-times "></em></a> 
                                        
                                            <a href="ModifierResponsable.php?&id=<?php echo $e->getId(); ?>" class="btn btn-success btn-default"style="border-radius: 7px;"><em class="fa fa-pencil "></em></a>
                                        </td>
        ...
        <script lang="javascript">
            ...
            {
                if(confirm("Voulez vous supprimer le reponsable ?")){
                    window.location.href='controller/deletereponsable.php?id='+delid+'';
                }   
            }
        </script>
