...
<html lang="en">
    ...
    <head>
        ...
        <!-- Page Title Here -->
        <title>ORMVAD - Modifier Reponsable</title>
                ...
                <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(images/banner/bnr1.jpg);">
                    <div class="container">
                        <div class="dez-bnr-inr-entry">
                            <h1 class="text-white">Gestion reponsable</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="breadcrumb-row">
                    <div class="container">
                        <ul class="list-inline">
                            <li><a href="adminStagiaire.php">Gestion reponsable</a></li>
                            <li>Modifier reponsable</li>
                        </ul>
                    </div>
                </div>
                <!-- Breadcrumb row END -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="p-a30 bg-gray clearfix m-b30 ">
                                    ...
                                    <form method="post" action="controller/ModifierResponsable.php" onSubmit="return verify(this.password, this.confirmMdp)">
					...
					$en = new RhServices();
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="nom" type="text" required class="form-control" value="<?php echo $res->getNom(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="prenom" type="text" required class="form-control" value="<?php echo $res->getPrenom(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="adresse" type="text" required class="form-control" value="<?php echo $res->getAdresse(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input name="telephone" type="text" required class="form-control" value="<?php echo $res->getTelephone(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group"> 
                                                        <input name="email" type="text" class="form-control" required  value="<?php echo $res->getEmail(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group"> 
                                                        <input name="login" type="text" class="form-control" required  value="<?php echo $res->getLogin(); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group"> 
                                                        <input name="mdp" type="text" class="form-control" required  value="<?php echo $res->getMdp(); ?>">
                                                    </div>
                                                </div>
                                            </div>
